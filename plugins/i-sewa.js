...
let handler = async (m, { conn, namebot, author, nomorown }) => {
  ...
  let txts = '```乂 P R I C E  S C R I P T```\n\n'
  txts += `➢ *Enc* : 75.000\n`
  txts += `➢ *No Enc* : 250.000\n`
  txts += '```-Benefit of buying scripts :```\n\n'
  txts += `*1.* can create your own bot\n`
  txts += `*2.* can access all features\n`
  txts += `*3.* Dll.\n\n`
  txts += ` ZenithBot Made By FuadXyro`
